...
def main():
    ...
    annopath = r'./../datasets/Validate_DOTA_1_0.5/labelTxt/{:s}.txt' # change the directory to the path of val/labelTxt, if you want to do evaluation on the valset
    imagesetfile = r'./../datasets/Validate_DOTA_1_0.5/val.txt'
